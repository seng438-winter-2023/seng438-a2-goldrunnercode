...
public class testCalculateColumnTotal extends DataUtilities {
	...
	public void testInvalidParameter() {
		double result = DataUtilities.calculateColumnTotal(null, 0); //inserting a null data type
	}
	...
	public void testShouldWork() {//this is a working test with valid values and column called
		// setup
	     ...
	     double result = DataUtilities.calculateRowTotal(values, 0); // get the result
	     // verify
